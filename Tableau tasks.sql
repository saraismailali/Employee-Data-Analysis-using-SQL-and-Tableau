...
d.dept_name,
 ...
 t.from_date, 
 e.calender_year ,
 CASE WHEN YEAR(t.to_date)>=e.calender_year AND  year(t.from_date)<= e.calender_year 
...
t_dept_manager t 
JOIN
t_departments d ON t.dept_no =d.dept_no
JOIN 
t_employees ee ON t.emp_no = ee.emp_no
ORDER BY  t.emp_no, calender_year;
